...
const MenuList2 = `Hello @${m.sender.split("@")[0]} (≧▽≦), Terimakasih Sudah Memakai Bot Ini Mohon Maaf Jika Masih Ada Beberapa Fitur Yang Error🙏 Silahkan Klick Button Dibawah Untuk Mengakses Bot Ini`
...
sock.sendMessage(from, { image: { url: random.male }, caption: `Saweria : ${Options.info.duituntukowner}` }, { quoted: m })
sock.sendMessage(from, { image: { url: random.female }, caption: `Bagi Duit Lah Anj` }, { quoted: m })
            }
	    break
 case 'speed':
if (q.includes('--help')) return reply(examkosong) 
